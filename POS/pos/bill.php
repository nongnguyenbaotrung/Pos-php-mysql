                                ...
                                if (isset($_GET["id_table"])) {
                                    ...
                                    if ($count == 1) {
                                        ...
                                        foreach ($select_tbl as $key => $value) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="quantity_item[]" value="<?php echo $value['quantity'] ?>" style="width: 30px; text-align: center;">
                                                </td>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="quantity_item[]" value="<?php echo $quantity ?>" style="width: 30px; text-align: center;">
                                            </td>
