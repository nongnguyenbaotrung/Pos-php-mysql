...
<div class="row">
    <div class="col-md-6">
        <div class="dropdown dropright">
            <a class="btn btn-success" href="pos_index.php">Quay Lại Bàn</a>
            ...
            <a href="?pos=sanpham&id_product=<?php echo $value['id'] ?>" class="text-dark" style="text-decoration: none;;">
                <div class="row mb-3 show-product mr-2" style="min-width: min-content; margin-left: 1px;">
                    <div class="col-md-6">
                        ...
                        <p style="font-weight: bold;text-align:left; color: black;" class="card-text"><br>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $value['name'] ?></p>
                    </div>
                    <div class="col-md-6">
                        <h6 class="card-text mt-1 text-center" style="color: red; font-weight: bold; clear:both;max-height:150px;min-width: min-content;"><?php echo number_format($value['price']) ?></h6>
                    </div>
                </div>
            </a>
        </div>
