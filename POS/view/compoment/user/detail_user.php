<?php
    ...
    if (isset($_POST['btn-update'])) {
        ...
        $update = $conn->query("UPDATE db_user SET `fullname`='$fullname', `password`='$password', `role`='$role', `email`='$email', 
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 pr-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="password" value="<?php echo $value['password'] ?>" name="password">
                                </div>
                            </div>
                            <div class="col-md-6 pr-1">
                            <div class="form-group">
                        ...
                        <div class="row">
                            <div class="update ml-auto mr-auto">
                                ...
                                <a class="btn btn-danger" href="?quanly=user">Close</a>
                            </div>
                        </div>
                    </form>
                    <?php } ?>
